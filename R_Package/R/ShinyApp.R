...
ShinyApp <- function(){
  ...
  MetaPipeX_data_full <- readr::read_csv(url("https://raw.githubusercontent.com/JensFuenderich/MetaPipeX_Update/main/Supplementary_Material/Table_Templates/5_MetaPipeX/MetaPipeX_template.csv"))
  codebook <- readr::read_csv(url("https://raw.githubusercontent.com/JensFuenderich/MetaPipeX_Update/main/Supplementary_Material/Table_Templates/5_MetaPipeX/codebook_for_meta_pipe_x_data.csv"))
      ...
      shiny::tabPanel(
        ...
        mainPanel(
          ...
          shiny::conditionalPanel(condition = "input.select_upload == 'MetaPipeX'",
                                  h3("MetaPipeX Data"),
                                  h5("Please provide a single .csv that has been produced by MetaPipeX::full_pipeline() or is arranged according to the", tags$a(href="https://raw.githubusercontent.com/JensFuenderich/MetaPipeX_Update/main/Supplementary_Material/Table_Templates/5_MetaPipeX/MetaPipeX_template.csv", "template on github.")),
    ...
    server <- function(input, output, session){
        ...
        if (input$select_upload == "IPD") {
          ...
          shiny::withProgress(message = 'Calculation in progress. This may take a moment.',
                              ...
                              style = "old",
                              {
                                ...
                                IPD_analzed <- MetaPipeX_Update::full_pipeline(data = IPD_list,
        ...
        if (input$select_upload == "ReplicationSum") {
          ...
          shiny::withProgress(message = 'Calculation in progress. This may take a moment.',
                              ...
                              style = "old",
                              {
                                ...
                                ReplicationSum_merged <- MetaPipeX_Update::merge_replication_summaries(data = ReplicationSum_list)

                                # run meta analyses
                                ReplicationSum_analyzed <- MetaPipeX_Update::meta_analyses(data = ReplicationSum_merged$Merged_Replication_Summaries)
      ...
      shiny::observeEvent(input$confirm_upload,{ # stores results in data_import$MergedReplicationSum_MetaPipeX
        ...
        if (input$select_upload == "MergedReplicationSum") {
          ...
          shiny::withProgress(message = 'Calculation in progress. This may take a moment.',
                              ...
                              {
                                # run meta analyses
                                ReplicationSum_analyzed <- MetaPipeX_Update::meta_analyses(data = MergedReplicationSum)
      ...
      output$zip_download <- shiny::downloadHandler(
        ...
        content = function(file){
          ...
          download.file("https://raw.githubusercontent.com/JensFuenderich/MetaPipeX_Update/main/Supplementary_Material/Analysis_Documentation/MetaPipeX_Analysis_Documentation.R",
