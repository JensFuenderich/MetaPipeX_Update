...
#'
#' @param Merged_Site_Summaries A data frame or path to a .csv format data frame that contains the merged site summaries. Use the MetaPipeXUpdate::merge_site_summaries function to create this data format, or use the href{https://github.com/JensFuenderich/MetaPipeX/blob/main/Supplementary_Material/Table_Templates/lvl3_merged_site_summaries/merged_site_summaries_template.csv}{{template on github}}.
#' @param Meta_Analyses A data frame or path to a .csv format data frame that contains the merged site summaries. Use the MetaPipeXUpdate::meta_analyze_MASCs function to create this data format, or use the href{https://github.com/JensFuenderich/MetaPipeX/tree/main/Supplementary_Material/Table_Templates/lvl4_meta_analyses}{{template on github}}.
...
create_MetaPipeX_format <- function(Merged_Site_Summaries, Meta_Analyses, output_folder = NULL, suppress_list_output = FALSE){
  ...
  # extract names from df and create codebook
  codebook_for_meta_pipe_x <- MetaPipeXUpdate:::create_MetaPipeX_codebook(description_vector = names(MetaPipeX_Data))
